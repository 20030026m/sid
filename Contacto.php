  ...
  annyang.start();
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse " id="ftco-nav">
        ...
        <li class="dropdown ">
							<a style="color: white;" href="#" ><a style="color: white;" href="index2.php">Inicio |</a></a>
      ...
      <div class="row block-12">
        <div class="col-md-6 pr-md-5">
          <form action="enviar.php" method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control px-3 py-3" placeholder="Telefono" name="asunto" >
            </div>
            <div class="form-group">
              <textarea  id="" cols="30" rows="7" class="form-control px-3 py-3" placeholder="Mensaje*" name="mensaje" required></textarea>
            </div>
            <div class="form-group">
              <input type="submit" value="Enviar mensaje" class="btn btn-primary py-3 px-5" style="background-color:Green";>
            </div>
          </form>
