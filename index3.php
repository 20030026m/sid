<?php  
//VISTA DE USUARIO COM PRIVILEGIO DE JEFE DE DIVISIÓN
...
if (annyang) {
  ...
  var comandos = {
    'contacto': function() {
      window.location.href = "Contacto/Contacto1.php";
    }
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse " id="ftco-nav">
        ...
        <li class="dropdown ">
						...
						<li class="dropdown ">
							<a  href="" ><a style="color: white;" href="Notificaciones.php">| Validaciones |</a> </a>
							<!-- Submenus -->
